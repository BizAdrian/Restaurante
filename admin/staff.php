...
<html lang="en">
  ...
  <head>
    ...
    <title>Administración de Empleados - BizAdrian</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Restaurante | BizAdrian</a>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Sistema de Restaurante BizAdrian 2024</span>
            </div>
          </div>
        </footer>
